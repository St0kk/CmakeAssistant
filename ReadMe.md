...
Расширение для Visual Studio Code, которое предостовляет удобное управление запуском программы и тестов для Cmake проектов, также выносит комманды на macbook touchbar.
